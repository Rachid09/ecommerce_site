    ...
    */
    ...
    $(".wc_payment_method label").on("click", function () {
        $(this)
            ...
            .siblings(".wc_payment_method")
            .removeClass("active");
        $(this).parent(".wc_payment_method").addClass("active");
    });

    $(".e-hover-wrapper-absolute .row, .e-hover-wrapper-absolute.row").each(
        function () {
    ...
    $('[class*="swatch-filter-"]').each(function () {
        ...
        if (count > 5) {
            $(this).append(
                '<div class="maxlist-more"> <span>+ Show More</span><span>- Show Less</span></div>'
            );
        }
    });
    ...
    if ($single_carousel.length) {
        $single_carousel.owlCarousel({
            ...
            nav: true,
            navText: [
                "<div class='nav-btn prev-slide'><i class='fas fa-chevron-left'></i><span>Prev</span></div>",
                "<div class='nav-btn next-slide'><span>Next</span><i class='fas fa-chevron-right'></i></div>",
            ],
            dots: true,
            smartSpeed: 500,
            autoplay: false,
