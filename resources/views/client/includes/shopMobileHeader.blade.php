                     ...
                     <form id="logout-form{{Auth::user()->id}}" action="{{ route('logout') }}" method="POST" style="display: none;">
                         @csrf
                                 ...
                                 <div class="sign-in position-relative font-general my-account-dropdown">
                                     ...
                                     <ul class="my-account-popup">
                                         <li><a href="{{route('seller.dashboard')}}"><span class="menu-item-text">My Account</span></a></li>
                                 ...
                                 <div class="sign-in position-relative font-general my-account-dropdown">
                                     ...
                                     <ul class="my-account-popup">
                                         <li><a href="{{route('admin.dashboard')}}"><span class="menu-item-text">My Account</span></a></li>
                                ...
                                <div class="header-cart-1">
                                    <a href="cart.html" class="cart has-cart-data" title="View Cart">
                                        <div class="cart-icon"><i class="flaticon-shopping-cart flat-mini"></i> <span class="header-cart-count">{{Cart::content()->count()}}</span></div>
                                        <div class="cart-wrap">
                                        ...
                                        <ul class="cart_list product_list_widget ">
                                            ...
                                            <li class="mini-cart-item">
                                                ...
                                                <div class="cart-item-quantity">{{$item->qty}} ×
                                                    <span class="woocommerce-Price-amount amount"><bdi>{{$item->model->price}}.00<span class="woocommerce-Price-currencySymbol">Dhs</span></bdi>
                                                    </span>
                                                </div>
                                            </li>
                                ...
                                <form class="form-inline search-pill-shape" action="#" method="post">
                                    ...
                                    <div class="select-appearance-none">
                                        <select class="form-control">
                                            <option selected>Tous les catégories</option>
