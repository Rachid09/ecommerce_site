             ...
             <div class="col-lg-8 d-flex">
                 <ul class="top-links d-flex ms-auto align-items-center">
                     ...
                     <li class="my-account-dropdown">
                         <a href="my-account.html" class="has-dropdown"><i class="flaticon-user-3 flat-mini me-1"></i>Se connecter</a>
                         <ul class="my-account-popup">
                             <li><a href="{{route('login')}}"><span class="menu-item-text">se connecter</span></a></li>
