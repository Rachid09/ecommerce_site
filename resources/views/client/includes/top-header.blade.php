                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4 sm-mx-none">
                            <div class="d-flex align-items-center">
                                <a href="help-center.html" class="text-general"><span>Help and Support</span></a>
                            </div>
                        </div>
                        <div class="col-lg-8 d-flex">
                            <ul class="top-links d-flex ms-auto align-items-center">
                                ...
                                <li class="my-account-dropdown">
                                    <a href="my-account.html" class="has-dropdown"><i class="flaticon-user-3 flat-mini text-primary me-1"></i>Mon compte</a>
                                    <ul class="my-account-popup">
                                        <li><a href="{{route('client.login')}}"><span class="menu-item-text">Se connecter</span></a></li>
