        ...
        <div class="row align-items-center">
            <div class="col-xxl-2 col-xl-2 col-lg-3 col-6 order-lg-1">
                <div class="d-flex align-items-center h-100 md-py-10">
                                        ...
                                        <div class="tab-pane fade show active woocommerce-Tabs-panel woocommerce-Tabs-panel--description" id="pills-push-menu" role="tabpanel" aria-labelledby="pills-push-menu-tab">
                                            <div class="push-navbar">
                                                <ul class="navbar-nav">
                                                    ...
                                                    <li class="nav-item"><a class="nav-link" href="index.html">Wood Made</a></li>
                                                    <li class="nav-item"><a class="nav-link" href="index.html">Kitchens</a></li>
                                                    <li class="nav-item"><a class="nav-link" href="index.html">Textiles</a></li>
                                            ...
                                            <div class="categories-menu">
                                                <ul class="menu">
                                                    <li class="menu-item-has-children unicode-megamenu-dropdown unicode-megamenu-item-full-width">
                                                        ...
                                                        <div class="unicode-megamenu-wrapper" style="background-image: url(/images/102.png49.png); background-size: cover;
                    ...
                    <a class="navbar-brand" href="index.html"><img class="nav-logo" src="public/images/logo-final.png" alt="Image not found !"></a>
                </div>
            </div>
                        ...
                        <div class="cart-popup">
                            <ul class="cart_list product_list_widget ">
                                <li class="mini-cart-item">
                                    ...
                                    <a href="#" class="product-image bg-gray"><img src="/images/101.png" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Cart product"></a>
