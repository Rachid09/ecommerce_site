                                ...
                                <div class="card-body">
                                    <form class="form-horizontal form-simple" action="{{route('seller.login')}}" method="post" novalidate>
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left mb-0">
                                            <input type="text" name="email" class="form-control form-control-lg input-lg" value="" id="email" placeholder="Email ">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" name="password" class="form-control form-control-lg input-lg" id="user-password" placeholder="Mot de pass">
                                            <div class="form-control-position">
                                                <i class="la la-key"></i>
                                            </div>
                                            @error('password')
                                        ...
                                        <button type="submit" name="submit" style="border: unset !important" class="btn btn-info btn-lg btn-block"><i class="ft-unlock"></i>
                                            Se connecter
                                        </button>
                                    </form>
                                </div>
