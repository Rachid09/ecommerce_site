...
<body class="vertical-layout vertical-menu 2-columns  @if(Request::is('public/admin/users/tickets/reply*')) chat-application @endif menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns">
