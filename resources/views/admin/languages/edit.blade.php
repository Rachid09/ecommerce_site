                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> Modifier اللغة</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name" name="nom" value="{{$language->nom}}" class="form-control" placeholder="ادخل اسم اللغة  " name="name">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$language->abbr}}" id="name" name="abbr" class="form-control" placeholder="ادخل اختصار اللغة  " name="name">
                                                        @error('abbr')
                                                        <span class="text-danger">{{$message}} </span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mt-1">
                                                        <input type="checkbox" value="1" name="is_active" id="switcheryColor4" class="switchery" data-color="success" @if($language->is_active == 1) checked @endif />
